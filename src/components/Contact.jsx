...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            form.append("access_key", "395cebc2-7687-44a9-9f0a-a44b1d08e163");
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            <div className="flex items-start gap-4">
                                ...
                                l bg-white/5 border border-white/10 text-white mt-1">
                                    <MapPin size={20} />
                                </div>
                                <div>
                                    <h4 className="text-white font-bold mb-1">Located at</h4>
                                    <p className="text-gray-400 text-sm">Jehanabad, Bihar, India</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:raj868537@gmail.com" className="text-gray-400 text-sm hover:text-teal-400 transition-colors">raj868537@gmail.com</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://github.com/Adityaraj86" target="_blank" rel="noreferrer" className="text-gray-400 text-sm hover:text-teal-400 transition-colors">github.com/aditya86</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://www.linkedin.com/in/adityaraj2112/" target="_blank" rel="noreferrer" className="text-gray-400 text-sm hover:text-teal-400 transition-colors">adityaraj2112</a>
                                </div>
                            </div>
                        </div>
                    </motion.div>
